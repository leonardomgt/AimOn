...
public class GameScreen extends ScreenAdapter {
    ...
    private void setModelController(int initialNumberOfDucks, int initialNumberOfBullets, int level) {
        ...
        this.model = new MainModel(MainController.getControllerWidth()/2, MainController.getControllerHeight()/2, initialNumberOfDucks, this.playerModel, level, HEIGHT_WIDTH_RATIO);
